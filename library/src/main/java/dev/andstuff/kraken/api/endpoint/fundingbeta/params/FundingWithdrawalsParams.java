...
/**
 * The parameters of List Funding Withdrawals ({@code GET /funding/v1/withdrawals}); omitted options use Kraken's defaults. A cursor must be sent without the other filters.
 */
@Getter
@Builder(toBuilder = true)
public class FundingWithdrawalsParams extends FundingBetaParams {
     ...
     */
    private final FundingWithdrawalStatus status;
    ...
    /**
     * The maximum number of withdrawals returned, up to 500.
     */
    private final Integer limit;

    /**
     * The earliest creation time of the withdrawals returned.
     */
    private final Instant startTime;

    /**
     * The latest creation time of the withdrawals returned.
     */
    ...
    public Map<String, String> toMap() {
        ...
        putIfNonNull(query, "status", status, FundingWithdrawalStatus::getValue);
