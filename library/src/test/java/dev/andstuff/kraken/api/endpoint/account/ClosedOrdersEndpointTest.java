...
import dev.andstuff.kraken.api.endpoint.account.params.CloseTime;
...
class ClosedOrdersEndpointTest {
    ...
    void should_deserialize_typed_response_when_reading_kraken_fixture() throws Exception {
        ...
        String json;
        try (InputStream fixture = getClass().getResourceAsStream("/account/ClosedOrders.json")) {
        ...
        assertThat(result.closed().get("O37652-RJWRT-IMO74O").closeTime()).isEqualTo(Instant.ofEpochSecond(1688148610L, 48200000L));
    }
}
